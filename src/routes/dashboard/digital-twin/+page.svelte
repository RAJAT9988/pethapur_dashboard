...
<svelte:head>
	<title>Digital Twin - Atomo Innovation</title>
</svelte:head>
...
<div class="dashboard">
	...
	<div class="twin-layout">
		<aside class="detection-tabs">
			...
			<a href="/dashboard/person" class="tab-card">
				...
				<div class="tab-info">
					...
					<span class="tab-stat">{liveStats.personTotal} detected</span>
				</div>
			</a>
		...
		<div class="twin-frame-wrap">
			<iframe title="3D Godown Digital Twin" src="/digital-twin.html" class="twin-iframe"></iframe>
		</div>
	</div>
</div>
...
<style>
	...
	.center-border {
		width: 4px;
		min-width: 4px;
		background: linear-gradient(180deg, rgba(37, 99, 235, 0) 0%, rgba(255, 255, 255, 0.9) 50%, rgba(37, 99, 235, 0) 100%);
		flex-shrink: 0;
	}
	...
	@media (max-width: 768px) {
		...
		.center-border {
			...
			min-width: 0;
			height: 4px;
			background: linear-gradient(90deg, rgba(37, 99, 235, 0) 0%, rgba(255, 255, 255, 0.9) 50%, rgba(37, 99, 235, 0) 100%);
		}
